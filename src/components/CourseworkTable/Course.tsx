    ...
    return (
        <>
            <td className="">
                ...
                <a target="_blank" aria-describedby={id} ref={refs.setReference} {...getReferenceProps()} href={props.href} className={`flex mx-auto w-28 h-8 my-1 justify-center items-center rounded-md ${props.className ?? ''}`}>
                    {props.abbreviation}
                </a>
            </td>
        </>
