...
export async function generateMetadata({ params }: { params: { slug: string } }): Promise<Metadata> {
  ...
  let openGraph: Metadata["openGraph"] = {
    ...
    url: `https://bedouch.net/projects/${params.slug}`,
  ...
  if (frontmatter.thumbnail) {
    openGraph.images = [{ url: `/project-assets/${frontmatter.slug}/${frontmatter.thumbnail}` }]
    twitter.images = [`/project-assets/${frontmatter.slug}/${frontmatter.thumbnail}`]
  }
